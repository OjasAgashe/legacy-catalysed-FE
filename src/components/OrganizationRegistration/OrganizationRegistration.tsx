...
const OrganizationRegistration = () => {
    ...
    return (
        ...
        <form className=" container  mt-4" >
            ...
            <input type="text" className="form-control form-control-sm first-name " placeholder="First Name"/> &nbsp;
            <input type="text" className="form-control form-control-sm last-name  overflow-hidden " placeholder="Last Name"/>
            </div><br/>
            <input type="email" className="form-control form-control-sm " placeholder="Your Official Email Id"/><br/>
